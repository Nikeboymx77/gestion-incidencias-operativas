...
class MailProcessorTest {
    ...
    void debeIgnorarCorreoInvalido() {
        ...
        when(mailValidator.validar(correo))
                .thenReturn(
                        MailValidationResult.invalido("Asunto obligatorio")
                );
    ...
    @Test
    void debeCrearIncidenciaAunqueMetadataEsteIncompleta() {
    ...
    private CorreoDTO crearCorreoValido() {
        ...
        return CorreoDTO.builder()
                ...
                .descripcion("""
                        ...
                        """)
                .fechaCorreo(
                        LocalDateTime.of(2026, 7, 14, 10, 15)
                )
